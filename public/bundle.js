...
render(tripControlsHeaderElements[0], createSiteMenuTemplate(), `afterend`);
render(tripControlsHeaderElements[1], createFilterTemplate(), `afterend`);
...
new Array(TASK_COUNT).fill(``).forEach(() => render(tripEventsListElement, createEventTemplate()));
